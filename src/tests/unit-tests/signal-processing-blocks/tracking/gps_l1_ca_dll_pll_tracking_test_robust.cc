...
class GpsL1CADllPllRobustTrackingTest_msg_rx;

#if GNURADIO_USES_STD_POINTERS
using GpsL1CADllPllRobustTrackingTest_msg_rx_sptr = std::shared_ptr<GpsL1CADllPllRobustTrackingTest_msg_rx>;
#else
using GpsL1CADllPllRobustTrackingTest_msg_rx_sptr = boost::shared_ptr<GpsL1CADllPllRobustTrackingTest_msg_rx>;
#endif

GpsL1CADllPllRobustTrackingTest_msg_rx_sptr GpsL1CADllPllRobustTrackingTest_msg_rx_make();

class GpsL1CADllPllRobustTrackingTest_msg_rx : public gr::block
{
private:
    friend GpsL1CADllPllRobustTrackingTest_msg_rx_sptr GpsL1CADllPllRobustTrackingTest_msg_rx_make();
    void msg_handler_events(pmt::pmt_t msg);
    GpsL1CADllPllRobustTrackingTest_msg_rx();

public:
    int rx_message;
    ~GpsL1CADllPllRobustTrackingTest_msg_rx();  //!< Default destructor
};


GpsL1CADllPllRobustTrackingTest_msg_rx_sptr GpsL1CADllPllRobustTrackingTest_msg_rx_make()
{
    return GpsL1CADllPllRobustTrackingTest_msg_rx_sptr(new GpsL1CADllPllRobustTrackingTest_msg_rx());
}


void GpsL1CADllPllRobustTrackingTest_msg_rx::msg_handler_events(pmt::pmt_t msg)
{
    try
        {
...
GpsL1CADllPllRobustTrackingTest_msg_rx::GpsL1CADllPllRobustTrackingTest_msg_rx() : gr::block("GpsL1CADllPllRobustTrackingTest_msg_rx", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
...
#else
        boost::bind(&GpsL1CADllPllRobustTrackingTest_msg_rx::msg_handler_events, this, _1));
#endif
    rx_message = 0;
}


GpsL1CADllPllRobustTrackingTest_msg_rx::~GpsL1CADllPllRobustTrackingTest_msg_rx() = default;


// ###########################################################

class GpsL1CADllPllRobustTrackingTest : public ::testing::Test
{
public:
    ...
    std::string p5;
    std::string p6;
    std::string implementation = "GPS_L1_CA_DLL_PLL_Tracking_robust";
    ...
    GpsL1CADllPllRobustTrackingTest()
    {
    ...
    ~GpsL1CADllPllRobustTrackingTest() = default;
...
int GpsL1CADllPllRobustTrackingTest::configure_generator(double CN0_dBHz, int file_idx)
{
...
int GpsL1CADllPllRobustTrackingTest::generate_signal()
{
    int child_status;
...
void GpsL1CADllPllRobustTrackingTest::configure_receiver(
...
std::vector<double> GpsL1CADllPllRobustTrackingTest::check_results_doppler(arma::vec& true_time_s,
    arma::vec& true_value,
    arma::vec& meas_time_s,
    arma::vec& meas_value,
    double& mean_error,
...
std::vector<double> GpsL1CADllPllRobustTrackingTest::check_results_acc_carrier_phase(arma::vec& true_time_s,
    arma::vec& true_value,
    arma::vec& meas_time_s,
    arma::vec& meas_value,
    double& mean_error,
...
std::vector<double> GpsL1CADllPllRobustTrackingTest::check_results_codephase(arma::vec& true_time_s,
    arma::vec& true_value,
    arma::vec& meas_time_s,
    arma::vec& meas_value,
    double& mean_error,
...
TEST_F(GpsL1CADllPllRobustTrackingTest, ValidationOfResults)
{
    // *************************************************
            ...
            for (unsigned int current_cn0_idx = 0; current_cn0_idx < generator_CN0_values.size(); current_cn0_idx++)
                {
                    ...
                    auto msg_rx = GpsL1CADllPllRobustTrackingTest_msg_rx_make();
...
bool GpsL1CADllPllRobustTrackingTest::save_mat_xy(std::vector<double>& x, std::vector<double>& y, std::string filename)
{
    try
        {
            // WRITE MAT FILE
