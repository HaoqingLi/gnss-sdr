...
#ifndef GNSS_SDR_DLL_PLL_VEML_TRACKING_ROBUST_H
...
class Gnss_Synchro;
class dll_pll_veml_tracking_robust;

#if GNURADIO_USES_STD_POINTERS
using dll_pll_veml_tracking_robust_sptr = std::shared_ptr<dll_pll_veml_tracking_robust>;
#else
using dll_pll_veml_tracking_robust_sptr = boost::shared_ptr<dll_pll_veml_tracking_robust>;
#endif
 ...
 */
class dll_pll_veml_tracking_robust : public gr::block
{
public:
    ~dll_pll_veml_tracking_robust();
