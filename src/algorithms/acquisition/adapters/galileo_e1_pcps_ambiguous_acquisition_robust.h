...
#ifndef GNSS_SDR_GALILEO_E1_PCPS_AMBIGUOUS_ACQUISITION_ROBUST_H
#define GNSS_SDR_GALILEO_E1_PCPS_AMBIGUOUS_ACQUISITION_ROBUST_H
 ...
 */
class GalileoE1PcpsAmbiguousAcquisitionrobust : public AcquisitionInterface
{
public:
    GalileoE1PcpsAmbiguousAcquisitionrobust(ConfigurationInterface* configuration,
        const std::string& role,
        unsigned int in_streams,
        unsigned int out_streams);

    ~GalileoE1PcpsAmbiguousAcquisitionrobust() = default;
