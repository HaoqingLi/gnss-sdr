 ...
 */
class GpsL1CaPcpsAcquisitionrobust : public AcquisitionInterface
{
public:
    GpsL1CaPcpsAcquisitionrobust(ConfigurationInterface* configuration,
        const std::string& role,
        unsigned int in_streams,
        unsigned int out_streams);

    ~GpsL1CaPcpsAcquisitionrobust() = default;
