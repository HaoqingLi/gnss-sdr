...
#ifndef GNSS_SDR_PCPS_ACQUISITION_ROBUST_H
#define GNSS_SDR_PCPS_ACQUISITION_ROBUST_H
...
#if GNURADIO_USES_STD_POINTERS
using pcps_acquisition_robust_sptr = std::shared_ptr<pcps_acquisition_robust>;
#else
 ...
 */
class pcps_acquisition_robust : public gr::block
{
public:
    ~pcps_acquisition_robust() = default;
