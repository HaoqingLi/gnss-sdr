...
Acq_robust_Conf::Acq_robust_Conf()
{
...
void Acq_robust_Conf::SetFromConfiguration(ConfigurationInterface *configuration,
...
void Acq_robust_Conf::ConfigureAutomaticResampler(double opt_freq)
{
    if (use_automatic_resampler)
        {
            if (fs_in > opt_freq)
...
void Acq_robust_Conf::SetDerivedParams()
{
